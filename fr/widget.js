...
export default {
    ...
    'status-header.soundsNote': 'Les notifications sonores restent actives quelques minutes après que l’onglet passe en arrière-plan',
     ...
     * Chat
     */
    'chat.attentionGrabber1': '⚡ Chattez avec les $N autres visiteurs en ligne maintenant!',
    'chat.attentionGrabber2': '⚡ Chattez avec les autres visiteurs en ligne maintenant!',
    // $N is a number
    // example: "⚡ Chat with the 2 other visitors online now!"

    'chat.welcomeMessage': 'Discutez avec d\'autres visiteurs en temps réel. Les messages sont publics et disparaissent après $N $A. Soyez aimable et amusez-vous!',
    'chat.welcomeMessageJWT': 'Discutez avec d\'autres visiteurs en temps réel. Les messages pourraient être publics et disparaître après $N $A. Soyez aimable et amusez-vous!',
    ...
    'chat.welcomeMessageNoExpiration': 'Discutez avec d\'autres visiteurs en temps réel. Les messages sont publics. Soyez aimable et amusez-vous!',
    'chat.welcomeMessageNoExpirationJWT': 'Discutez avec d\'autres visiteurs en temps réel. Les messages pourraient être publics. Soyez aimable et amusez-vous!',
    ...
    'chat.loadMoreError': 'Impossible de charger les anciens messages',
    'chat.editNotAuthorizedError': 'Ce message ne peut pas être modifié',
    'chat.deleteNotAuthorizedError': 'Ce message ne peut pas être supprimé',

    'chat.copiedInfo': 'Message copié',
    ...
    'chat.copyBtn': 'Copier', // means "copy this message"
    ...
    'chat.editBtn': 'Modifier', // means "edit this message"

    'chat.userIdenticon': 'Empreinte utilisateur',
    
    'chat.showMoreBtn': 'Afficher plus',
    'chat.showLessBtn': 'Afficher moins',
     ...
     * GIF-picker labels
     */
    'gif-picker.search': 'Rechercher KLIPY',
    'gif-picker.retry': 'Erreur lors du chargement des GIFs. <a>Réessayez</a>',
    ...
    'poll-modal.viewVotesButton': 'Résultats',
     ...
     */
    'delete-message-confirmation-modal.message': 'Êtes-vous sûr de vouloir supprimer ce message ?'
}