...
export default {
    ...
    'chat.reactionPickerBtn': 'Wybierz reakcję',
    'chat.reactionsTitle': 'Reakcje',
    'chat.reactionsAll': 'Wszystkie',
    'chat.reactionsRemoveHint': 'Usuń swoją reakcję',
    'chat.youLabel': 'Ty',
     ...
     * GIF-picker labels
     */
    'gif-picker.search': 'Szukaj KLIPY',
